...
Copy-Item '..\\policies\\chungyeok\\privacy-policy.html' (Join-Path $packageDir 'privacy-policy.html') -Force
...
3) Set privacy policy URL: https://jeongdawoont-star.github.io/hash2n/policies/chungyeok/privacy-policy.html
